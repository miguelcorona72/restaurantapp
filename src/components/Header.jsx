    ...
    <header className="fixed z-50 w-screen p-3 px-4 md:p-6 md:px-16 bg-primary">
        ...
        <div className="hidden md:flex w-full h-full items-center justify-between">
            <Link to={"/"} className="flex items-center gap-2">
                ...
                <p className="text-headingColor text-xl font-bold"> CIEN DIEZ</p>
            </Link>
            ...
            <div className="flex items-center gap-8">
                ...
                >
                    <li className="text-base text-textColor hover:textheadingColor duration-100 transition-all ease-in-out cursor-pointer">
                        Home
                    </li>
                    <li className="text-base text-textColor hover:textheadingColor duration-100 transition-all ease-in-out cursor-pointer">
                        Menú
                ...
                <div className="relative">
                    ...
                    {isMenu && (
                        <motion.div 
                            ...
                            className="w-40 bg-gray-50 shahow-xl rounded-lg flex flex-col absolute top-12 right-0">

                            {user && user.email === "mikeecoronad@gmail.com" && (
                                <Link to={"/createItem"}>
        ...
        <div className="flex items-center justify-between md:hidden w-full h-full">        
            ...
            <div className="relative">
                ...
                <ul className="flex flex-col">
                    <li className="text-base text-textColor hover:textheadingColor duration-100 transition-all ease-in-out cursor-pointer hover:bg-slate-100 px-4 py-2"
                    onClick={() => setIsMenu(false)}
                    >
                        Home
                    </li>
